...
def test_ecooler_emittance(test_context):
    ...
    particle_ref = xp.Particles(
        p0c=p0c, q0=q0, mass0=mass0, beta0=beta0,
        gamma0=gamma0, _context=test_context)
    ...
    line_matching.build_tracker(_context=test_context)
...
def test_ecooler_force(test_context):
    ...
    # Reference particle
    particle_ref = xp.Particles(p0c=p0c, mass0=mass0, q0=q0, _context=test_context)
