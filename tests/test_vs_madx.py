    ...
    for configuration in ['b1_with_errors', 'b2_no_errors']:
        ...
        for context in xo.context.get_test_contexts():
            ...
            for simplified, tracker in zip((False, True), [tracker_full, tracker_simplified]):
                ...
                twxt4d = tracker.twiss(mode='4d', reverse=reverse)
                ...
                tw4d_init = tracker.twiss(mode='4d').get_twiss_init(at_element=range_for_partial_twiss[0])
                ...
                tw4d_part = tracker.twiss(mode='4d', ele_start=range_for_partial_twiss[0],
