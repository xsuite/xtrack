...
def test_multitracker():
    ...
    for context in xo.context.get_test_contexts():
        ...
        tracker1 = xt.Tracker(_context=context,
        ...
        tracker2 = xt.Tracker(_context=context,
            line=xt.Line(elements=[xt.Drift(length=1),
        ...
        p1 = xp.Particles(p0c=7e12, x=[0,0,0], _context=context)
        p2 = xp.Particles(p0c=7e12, x=[0,0,0], _context=context)
        p3 = xp.Particles(p0c=7e12, x=[0,0,0], _context=context)
