...
void YRotation_track_local_particle(YRotationData el, LocalParticle* part0){
    ...
    //start_per_particle_block (part0->part)
        ...
        LocalParticle_set_zeta(part,t*beta0/beta);
