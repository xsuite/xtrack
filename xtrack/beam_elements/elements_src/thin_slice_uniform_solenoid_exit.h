...
void ThinSliceUniformSolenoidExit_track_local_particle(
    ...
    track_magnet_particles(
        /*weight*/                0., // unused
        /*part0*/                 part0,
        /*length*/                ThinSliceUniformSolenoidExitData_get__parent_length(el),
        /*order*/                 ThinSliceUniformSolenoidExitData_get__parent_order(el),
      ...
      /*inv_factorial_order_rel*/ 0,
        ...
        /*radiation_flag*/        ThinSliceUniformSolenoidExitData_get_radiation_flag(el),
        /*radiation_flag_parent*/ ThinSliceUniformSolenoidExitData_get__parent_radiation_flag(el),
        /*radiation_record*/      NULL,
        /*delta_taper*/           ThinSliceUniformSolenoidExitData_get_delta_taper(el),
        /*h*/                     0.,
        /*hxl*/                   0.,
        ...
        /*ks*/                    XT_STRENGTH_LIFT(ThinSliceUniformSolenoidExitData_get__parent_ks(el)),
        /*dks_ds*/                0.,
...
#endif // XTRACK_EXIT_SLICE_UNIFORM_SOLENOID_H