...
void Octupole_track_local_particle(
    ...
    track_magnet_particles(
      ...
      /*inv_factorial_order_rel*/ one_over_factorial(OctupoleData_len_knl_rel(el) - 1), // 1 / (order_rel)!
        ...
        /*rel_ref_strength*/      XT_STRENGTH_LIFT(OctupoleData_get_length(el) * ((OctupoleData_get_main_is_skew(el)) ? OctupoleData_get_k3s(el) : OctupoleData_get_k3(el))),
        ...
        /*k3*/                    XT_STRENGTH_LIFT(OctupoleData_get_k3(el)),
        /*k0s*/                  XT_STRENGTH_LIFT(0.),
        /*k1s*/                  XT_STRENGTH_LIFT(0.),
        /*k2s*/                  XT_STRENGTH_LIFT(0.),
        /*k3s*/                   XT_STRENGTH_LIFT(OctupoleData_get_k3s(el)),
