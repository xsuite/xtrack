...
void ThinSliceMultipole_track_local_particle(ThinSliceMultipoleData el, LocalParticle* part0){
    ...
    track_magnet_particles(
      ...
      /*inv_factorial_order_rel*/ one_over_factorial(ThinSliceMultipoleData_len__parent_knl_rel(el) - 1), // 1 / (order_rel)!
        ...
        /*main_strength*/         XT_STRENGTH_LIFT((ThinSliceMultipoleData_get__parent_main_is_skew(el)) ? (ThinSliceMultipoleData_get__parent_ksl(el, ThinSliceMultipoleData_get__parent_main_order(el))) : (ThinSliceMultipoleData_get__parent_knl(el, ThinSliceMultipoleData_get__parent_main_order(el)))),
