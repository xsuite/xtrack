...
void Sextupole_track_local_particle(
    ...
    track_magnet_particles(
      ...
      /*inv_factorial_order_rel*/ one_over_factorial(SextupoleData_len_knl_rel(el) - 1), // 1 / (order_rel)!
        ...
        /*rel_ref_strength*/      XT_STRENGTH_LIFT(SextupoleData_get_length(el) * ((SextupoleData_get_main_is_skew(el)) ? SextupoleData_get_k2s(el) : SextupoleData_get_k2(el))),
        ...
        /*k2*/                    XT_STRENGTH_LIFT(SextupoleData_get_k2(el)),
        /*k3*/                   XT_STRENGTH_LIFT(0.),
        /*k0s*/                  XT_STRENGTH_LIFT(0.),
        /*k1s*/                  XT_STRENGTH_LIFT(0.),
        /*k2s*/                   XT_STRENGTH_LIFT(SextupoleData_get_k2s(el)),
