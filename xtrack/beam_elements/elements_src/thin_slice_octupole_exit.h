...
void ThinSliceOctupoleExit_track_local_particle(
    ...
    track_magnet_particles(
        /*weight*/                0., // unused
        /*part0*/                 part0,
        /*length*/                ThinSliceOctupoleExitData_get__parent_length(el),
        /*order*/                 ThinSliceOctupoleExitData_get__parent_order(el),
      ...
      /*inv_factorial_order_rel*/ 1. / (tgamma(ThinSliceOctupoleExitData_len__parent_knl_rel(el))), // 1 / (order_rel)! = 1 / tgamma(order_rel + 1)
        /*knl_rel*/               ThinSliceOctupoleExitData_getp1__parent_knl_rel(el, 0),
        /*ksl_rel*/               ThinSliceOctupoleExitData_getp1__parent_ksl_rel(el, 0),
        /*rel_ref_strength*/      ThinSliceOctupoleExitData_get__parent_length(el) * ((ThinSliceOctupoleExitData_get__parent_rel_ref_is_skew(el)) ? ThinSliceOctupoleExitData_get__parent_k3s(el) : ThinSliceOctupoleExitData_get__parent_k3(el)),
        /*num_multipole_kicks*/   0, // unused
        /*model*/                 0, // unused
        /*default_model*/         OCTUPOLE_DEFAULT_MODEL,
        /*integrator*/            0, // unused
        /*default_integrator*/    OCTUPOLE_DEFAULT_INTEGRATOR,
        /*radiation_flag*/        ThinSliceOctupoleExitData_get_radiation_flag(el),
        /*radiation_flag_parent*/ ThinSliceOctupoleExitData_get__parent_radiation_flag(el),
        /*radiation_record*/      NULL,
        /*delta_taper*/           ThinSliceOctupoleExitData_get_delta_taper(el),
        /*h*/                     0.,
        /*hxl*/                   0.,
        /*k0*/                    0.,
        /*k1*/                    0.,
        /*k2*/                    0.,
        /*k3*/                    ThinSliceOctupoleExitData_get__parent_k3(el),
        /*k0s*/                   0.,
        /*k1s*/                   0.,
        /*k2s*/                   0.,
...
#endif // XTRACK_EXIT_SLICE_OCTUPOLE_H