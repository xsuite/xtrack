...
void ThinSliceOctupoleExit_track_local_particle(
    ...
    track_magnet_particles(
      ...
      /*inv_factorial_order_rel*/ one_over_factorial(ThinSliceOctupoleExitData_len__parent_knl_rel(el) - 1), // 1 / (order_rel)!
        ...
        /*rel_ref_strength*/      XT_STRENGTH_LIFT(ThinSliceOctupoleExitData_get__parent_length(el) * ((ThinSliceOctupoleExitData_get__parent_main_is_skew(el)) ? ThinSliceOctupoleExitData_get__parent_k3s(el) : ThinSliceOctupoleExitData_get__parent_k3(el))),
        ...
        /*k3*/                    XT_STRENGTH_LIFT(ThinSliceOctupoleExitData_get__parent_k3(el)),
        /*k0s*/                  XT_STRENGTH_LIFT(0.),
        /*k1s*/                  XT_STRENGTH_LIFT(0.),
        /*k2s*/                  XT_STRENGTH_LIFT(0.),
        /*k3s*/                   XT_STRENGTH_LIFT(ThinSliceOctupoleExitData_get__parent_k3s(el)),
