...
void ThinSliceQuadrupole_track_local_particle(
    ...
    track_magnet_particles(
      ...
      /*inv_factorial_order_rel*/ one_over_factorial(ThinSliceQuadrupoleData_len__parent_knl_rel(el) - 1), // 1 / (order_rel)!
        /*knl_rel*/               ThinSliceQuadrupoleData_getp1__parent_knl_rel(el, 0),
        /*ksl_rel*/               ThinSliceQuadrupoleData_getp1__parent_ksl_rel(el, 0),
        /*rel_ref_strength*/      XT_STRENGTH_LIFT(ThinSliceQuadrupoleData_get__parent_length(el) * ((ThinSliceQuadrupoleData_get__parent_main_is_skew(el)) ? ThinSliceQuadrupoleData_get__parent_k1s(el) : ThinSliceQuadrupoleData_get__parent_k1(el))),
        ...
        /*k1*/                    XT_STRENGTH_LIFT(ThinSliceQuadrupoleData_get__parent_k1(el)),
        /*k2*/                   XT_STRENGTH_LIFT(0.),
        /*k3*/                   XT_STRENGTH_LIFT(0.),
        /*k0s*/                  XT_STRENGTH_LIFT(0.),
        /*k1s*/                   XT_STRENGTH_LIFT(ThinSliceQuadrupoleData_get__parent_k1s(el)),
...
#endif // XTRACK_THIN_SLICE_QUADRUPOLE_H
