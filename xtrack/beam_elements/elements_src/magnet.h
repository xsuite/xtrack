...
void Magnet_track_local_particle(
    ...
    track_magnet_particles(
      ...
      /*inv_factorial_order_rel*/ 0,
        /*knl_rel*/               NULL,
        /*ksl_rel*/               NULL,
        /*rel_ref_strength*/      XT_STRENGTH_LIFT(0.),
        ...
        /*hxl*/                   0.,
        /*k0*/                    XT_STRENGTH_LIFT(MagnetData_get_k0(el)),
        /*k1*/                    XT_STRENGTH_LIFT(MagnetData_get_k1(el)),
        /*k2*/                    XT_STRENGTH_LIFT(MagnetData_get_k2(el)),
        /*k3*/                    XT_STRENGTH_LIFT(MagnetData_get_k3(el)),
        /*k0s*/                   XT_STRENGTH_LIFT(MagnetData_get_k0s(el)),
        /*k1s*/                   XT_STRENGTH_LIFT(MagnetData_get_k1s(el)),
        /*k2s*/                   XT_STRENGTH_LIFT(MagnetData_get_k2s(el)),
        /*k3s*/                   XT_STRENGTH_LIFT(MagnetData_get_k3s(el)),
