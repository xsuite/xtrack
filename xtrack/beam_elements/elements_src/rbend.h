...
void RBend_track_local_particle(
    ...
    track_magnet_particles(
      ...
      /*inv_factorial_order_rel*/ one_over_factorial(RBendData_len_knl_rel(el) - 1), // 1 / (order_rel)!
        ...
        /*rel_ref_strength*/      XT_STRENGTH_LIFT(RBendData_get_k0(el) * RBendData_get_length(el)),
        ...
        /*hxl*/                   0.,
        /*k0*/                    XT_STRENGTH_LIFT(RBendData_get_k0(el)),
        /*k1*/                    XT_STRENGTH_LIFT(RBendData_get_k1(el)),
        /*k2*/                    XT_STRENGTH_LIFT(RBendData_get_k2(el)),
