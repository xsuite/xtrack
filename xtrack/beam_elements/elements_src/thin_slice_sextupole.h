...
void ThinSliceSextupole_track_local_particle(
    ...
    track_magnet_particles(
      ...
      /*inv_factorial_order_rel*/ one_over_factorial(ThinSliceSextupoleData_len__parent_knl_rel(el) - 1), // 1 / (order_rel)!
        /*knl_rel*/               ThinSliceSextupoleData_getp1__parent_knl_rel(el, 0),
        /*ksl_rel*/               ThinSliceSextupoleData_getp1__parent_ksl_rel(el, 0),
        /*rel_ref_strength*/      XT_STRENGTH_LIFT(ThinSliceSextupoleData_get__parent_length(el) * ((ThinSliceSextupoleData_get__parent_main_is_skew(el)) ? ThinSliceSextupoleData_get__parent_k2s(el) : ThinSliceSextupoleData_get__parent_k2(el))),
        ...
        /*k2*/                    XT_STRENGTH_LIFT(ThinSliceSextupoleData_get__parent_k2(el)),
        /*k3*/                   XT_STRENGTH_LIFT(0.),
        /*k0s*/                  XT_STRENGTH_LIFT(0.),
        /*k1s*/                  XT_STRENGTH_LIFT(0.),
        /*k2s*/                   XT_STRENGTH_LIFT(ThinSliceSextupoleData_get__parent_k2s(el)),
...
#endif // XTRACK_THIN_SLICE_SEXTUPOLE_H
