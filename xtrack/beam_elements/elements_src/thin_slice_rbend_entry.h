...
/*order_rel*/             0,
      /*inv_factorial_order_rel*/ 1,
        ...
        /*rel_ref_strength*/      ((ThinSliceRBendEntryData_get__parent_rel_ref_is_skew(el)) ? (ThinSliceRBendEntryData_get__parent_k0s(el)) : (ThinSliceRBendEntryData_get__parent_k0(el))),
