...
void configure_tracking_model(
    ...
    xt_float_or_tpsa* k0_drift,
    xt_float_or_tpsa* k1_drift,
    double* h_drift,
    xt_float_or_tpsa* ks_drift,
    xt_float_or_tpsa* k0_kick,
    xt_float_or_tpsa* k1_kick,
    double* h_kick,
    xt_float_or_tpsa* k0_h_correction,
    xt_float_or_tpsa* k1_h_correction,
