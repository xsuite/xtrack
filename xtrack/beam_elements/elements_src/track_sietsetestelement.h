...
GPUFUN
void Sietse_single_particle(LocalParticle* part, double Bs, double length)
{
    ...
    double const x_hat  = x + px * length / beta / c / gamma / mass;
    double const y_hat  = y + py * length / beta / c / gamma / mass;
    double const px_hat = px + q0 / beta / c / gamma / mass * Bs * py * length;
    double const py_hat = py - q0 / beta / c / gamma / mass * Bs * px * length;
