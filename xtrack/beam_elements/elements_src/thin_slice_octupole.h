...
void ThinSliceOctupole_track_local_particle(
    ...
    track_magnet_particles(
        ...
        /*order_rel*/             ThinSliceOctupoleData_len__parent_knl_rel(el) - 1, // order_rel is derived from the length of knl_rel and ksl_rel arrays
      /*inv_factorial_order_rel*/ one_over_factorial(ThinSliceOctupoleData_len__parent_knl_rel(el) - 1), // 1 / (order_rel)!
        /*knl_rel*/               ThinSliceOctupoleData_getp1__parent_knl_rel(el, 0),
        /*ksl_rel*/               ThinSliceOctupoleData_getp1__parent_ksl_rel(el, 0),
        /*rel_ref_strength*/      XT_STRENGTH_LIFT(ThinSliceOctupoleData_get__parent_length(el) * ((ThinSliceOctupoleData_get__parent_main_is_skew(el)) ? ThinSliceOctupoleData_get__parent_k3s(el) : ThinSliceOctupoleData_get__parent_k3(el))),
        ...
        /*k3*/                    XT_STRENGTH_LIFT(ThinSliceOctupoleData_get__parent_k3(el)),
        /*k0s*/                  XT_STRENGTH_LIFT(0.),
        /*k1s*/                  XT_STRENGTH_LIFT(0.),
        /*k2s*/                  XT_STRENGTH_LIFT(0.),
        /*k3s*/                   XT_STRENGTH_LIFT(ThinSliceOctupoleData_get__parent_k3s(el)),
