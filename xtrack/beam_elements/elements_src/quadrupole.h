...
void Quadrupole_track_local_particle(
    ...
    track_magnet_particles(
      ...
      /*inv_factorial_order_rel*/ one_over_factorial(QuadrupoleData_len_knl_rel(el) - 1), // 1 / (order_rel)!
        /*knl_rel*/               QuadrupoleData_getp1_knl_rel(el, 0),
        /*ksl_rel*/               QuadrupoleData_getp1_ksl_rel(el, 0),
        /*rel_ref_strength*/      XT_STRENGTH_LIFT(QuadrupoleData_get_length(el) * ((QuadrupoleData_get_main_is_skew(el)) ? QuadrupoleData_get_k1s(el) : QuadrupoleData_get_k1(el))),
        ...
        /*k1*/                    XT_STRENGTH_LIFT(QuadrupoleData_get_k1(el)),
        /*k2*/                   XT_STRENGTH_LIFT(0.),
        /*k3*/                   XT_STRENGTH_LIFT(0.),
        /*k0s*/                  XT_STRENGTH_LIFT(0.),
        /*k1s*/                   XT_STRENGTH_LIFT(QuadrupoleData_get_k1s(el)),
