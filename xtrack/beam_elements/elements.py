...
class DriftExact(BeamElement):
    """Beam element modeling a drift section without parabolic approximation.
    Parameters:
          - length [m]: Length of the drift section. Default is ``0``.
    """
...
DriftExact.XoStruct.extra_sources = [
    _pkg_root.joinpath("beam_elements/elements_src/drift_exact.h")
]
