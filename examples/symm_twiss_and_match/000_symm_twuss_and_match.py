...
elements={
    ...
    'qf1': xt.Quadrupole(k1=1.1, length=0.05),
    'drift1_1': xt.Drift(length=0.1),
    'bend1': xt.Bend(k0=0.001, h=0.001, length=5.5),
    ...
    'bend2': xt.Bend(k0=0.001, h=0.001, length=5.5),
    'drift4_2': xt.Drift(length=0.1),
    'qf2': xt.Quadrupole(k1=1.1, length=0.05),
