#!/usr/bin/env python3
"""List xtrack.Line members that are neither methods nor properties."""
...
def main():
    ...
    print()
    print(f"Members in dir(line) that are not methods/properties ({len(found)}):")
