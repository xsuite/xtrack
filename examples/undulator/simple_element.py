...
final_x = particles.x.copy()
final_y = particles.y.copy()
final_px = particles.px.copy()
final_py = particles.py.copy()
final_zeta = particles.zeta.copy()
final_delta = particles.delta.copy()

print("Final State - Initial State:")
print(f"final_x - initial_x = {final_x - initial_x}")
print(f"final_y - initial_y = {final_y - initial_y}")
print(f"final_px - initial_px = {final_px - initial_px}")
print(f"final_py - initial_py = {final_py - initial_py}")
print(f"final_zeta - initial_zeta = {final_zeta - initial_zeta}")
print(f"final_delta - initial_delta = {final_delta - initial_delta}")