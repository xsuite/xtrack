...
env.new('wig_pole', 'Bend',
        ...
        k0='wig_k0',
        angle=0, # Straight magnet (no reference frame curvature)
        k0_from_h=False, # Control k0 and h independently
        rot_s_rad='wig_tilt_rad')

env.new_line(name='wig_period', components=[
    env.new('wig_pole_1', 'wig_pole', k0='-wig_k0', angle=0),
    env.new('wig_pole_2', 'wig_pole', k0='wig_k0', angle=0),
    env.new('wig_pole_3', 'wig_pole', k0='wig_k0', angle=0),
    env.new('wig_pole_4', 'wig_pole', k0='-wig_k0', angle=0),
])
