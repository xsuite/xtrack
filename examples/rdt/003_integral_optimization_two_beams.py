...
integral_optim_ir1_b1  = xt.IntegralOptimization(
    ...
    vary=xt.VaryList(['kqsx3.r1', 'kqsx3.l1'], step=1e-6),
    target_quantities={'f1001_b1': 'f1001'},
    generated_knob_name='on_corr_k1s_ir1_local'
)
...
env['kqsx3.l1_from_on_corr_k1s_ir1_local'] = 'kqsx3.r1_from_on_corr_k1s_ir1_local'
opt_ir1.disable(vary_name='kqsx3.l1_from_on_corr_k1s_ir1_local')
opt_ir1.step(n_steps=5)
