...
assert ee['c'] == 16
assert ee['mb'].k1 == 12
assert ee['mb'].angle == 16
assert ee['mb'].knl[0] == 0
assert ee['mb'].knl[1] == 20
assert ee['mb'].knl[2] == 24

ee['mb'].k1 = '30*a'
ee['mb'].angle = 40 * ee.ref['a']
ee['mb'].knl[1] = '50*a'
ee['mb'].knl[2] = 60 * ee.ref['a']
assert ee['mb'].k1 == 120
assert ee['mb'].angle == 160
assert ee['mb'].knl[0] == 0
