...
line.vars.update({
    'kqs.r3b1':   -3.41388e-06,
    'kqs.l4b1':   -3.41388e-06,
    'kqs.a67b1':  -1.81655e-06,
    'kqs.r7b1':    4.42367e-06,
    'kqs.l8b1':    4.42367e-06,
    'kqs.a23b1':  -4.39673e-06,
})
...
xo.assert_allclose(tw.c_minus_re + 1j*tw.c_minus_im, c_min_from_k1s, rtol=4e-2, atol=0)
...
plt.close('all')
plt.figure(1)
plt.plot(tw.s, np.abs(tw.c_minus_re + 1j*tw.c_minus_im)/np.abs(c_min_from_k1s))
