...
line = env.new_line(length=1., components=[
    ...
    env.new('mxrot', xt.XRotation, angle=-12, at=0.4),
])
...
xo.assert_allclose(tw.spin_x, 1., rtol=0, atol=1e-9)
