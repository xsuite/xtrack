...
spin_z_angle_bmad = np.array(spin_z_angle_bmad)
spin_z_angle_test = np.array(spin_z_angle_test)
spin_x_angle_bmad = np.array(spin_x_angle_bmad)
spin_x_angle_test = np.array(spin_x_angle_test)
spin_y_angle_bmad = np.array(spin_y_angle_bmad)
spin_y_angle_test = np.array(spin_y_angle_test)
spin_z_angle_test_python = np.array(spin_z_angle_test_python)
spin_x_angle_test_python = np.array(spin_x_angle_test_python)
spin_y_angle_test_python = np.array(spin_y_angle_test_python)
...
plt.plot(px_vect, spin_x_angle_test/spin_x_angle_bmad, 'o-', label='xtrack / bmad')
plt.plot(px_vect, spin_x_angle_test_python/spin_x_angle_bmad, 'o-', label='xtrack python / bmad')
plt.xlabel('px')
plt.ylabel('spin x ratio')
plt.legend()
...
plt.legend()
plt.subplot(212, sharex=aa)
plt.plot(px_vect, spin_y_angle_test/spin_y_angle_bmad, 'o-', label='xtrack / bmad')
plt.plot(px_vect, spin_y_angle_test_python/spin_y_angle_bmad, 'o-', label='xtrack python / bmad')
plt.xlabel('py')
plt.ylabel('spin y ratio')
plt.legend()
...
plt.legend()
plt.subplot(212, sharex=aa)
plt.plot(px_vect, spin_z_angle_test/spin_z_angle_bmad, 'o-', label='xtrack / bmad')
plt.plot(px_vect, spin_z_angle_test_python/spin_z_angle_bmad, 'o-', label='xtrack python / bmad')
plt.xlabel('px')
plt.ylabel('spin z ratio')
