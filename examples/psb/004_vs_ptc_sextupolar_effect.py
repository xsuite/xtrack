...
plt.close('all')
sext_effect = np.linspace(0, 1, 11)
qx_mad =[]
qy_mad =[]
dqx_mad2 =[]
dqy_mad2 =[]
...
bety_sel_xsuite = []
bety_sel_ptc = []
for ii, ss in enumerate(sext_effect):
    ...
    plt.suptitle(f'sext effect = {ss*100:.1f} %')

    plt.legend()

plt.figure(100)
sp1 = plt.subplot(2,1,1)
plt.plot(sext_effect, qx_xsuite, label='xtrack')
plt.plot(sext_effect, qx_ptc, label='ptc')
plt.legend()
plt.ylabel('qx')

plt.subplot(2,1,2, sharex=sp1, sharey=sp1)
plt.plot(sext_effect, qy_xsuite, label='xtrack')
plt.plot(sext_effect, qy_ptc, label='ptc')
plt.legend()
plt.ylabel('qy')
...
plt.figure(101)
sp1 = plt.subplot(2,1,1)
plt.plot(sext_effect, dqx_mad2, label='madx')
plt.plot(sext_effect, dqx_xsuite, label='xtrack')
plt.legend()
plt.ylabel('dqx')


plt.subplot(2,1,2, sharex=sp1, sharey=sp1)
plt.plot(sext_effect, dqy_mad2, label='madx')
plt.plot(sext_effect, dqy_xsuite, label='xtrack')
plt.legend()
plt.ylabel('dqy')
plt.xlabel('bump amplitude')
...
plt.figure(102)
sp1 = plt.subplot(2,1,1)
plt.plot(sext_effect, betx_sel_xsuite, label='xtrack')
plt.plot(sext_effect, betx_sel_ptc, label='ptc')
plt.legend()
plt.ylabel('betx [m]')

plt.subplot(2,1,2, sharex=sp1, sharey=sp1)
plt.plot(sext_effect, bety_sel_xsuite, label='xtrack')
plt.plot(sext_effect, bety_sel_ptc, label='ptc')
plt.legend()
plt.ylabel('bety [m]')
plt.xlabel('bump amplitude')
