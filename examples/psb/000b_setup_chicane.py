...
tw = line.twiss()
assert np.isclose(tw['x', 'bi1.tstr1l1_entry'], -0.045716, rtol=0, atol=1e-5)
assert np.isclose(tw['y', 'bi1.tstr1l1_entry'], 0.0000000, rtol=0, atol=1e-5)
assert np.isclose(tw['betx', 'bi1.tstr1l1_entry'], 5.203667, rtol=0, atol=1e-4)
assert np.isclose(tw['bety', 'bi1.tstr1l1_entry'], 6.902887, rtol=0, atol=1e-4)
