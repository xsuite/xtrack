...
line['qc1r1.1'].k1s = 'on_corr_ip.1 * ks0.r1'
line['qc2r1.1'].k1s = 'on_corr_ip.1 * ks1.r1'
line['qc2r2.1'].k1s = 'on_corr_ip.1 * ks2.r1'
line['qc1r2.1'].k1s = 'on_corr_ip.1 * ks3.r1'
line['qc1l1.4'].k1s = 'on_corr_ip.1 * ks0.l1'
line['qc2l1.4'].k1s = 'on_corr_ip.1 * ks1.l1'
line['qc2l2.4'].k1s = 'on_corr_ip.1 * ks2.l1'
line['qc1l2.4'].k1s = 'on_corr_ip.1 * ks3.l1'
...
line['mcb1.r1'].knl[0] = 'on_corr_ip.1 * acb1h.r1'
line['mcb2.r1'].knl[0] = 'on_corr_ip.1 * acb2h.r1'
line['mcb1.r1'].ksl[0] = 'on_corr_ip.1 * acb1v.r1'
line['mcb2.r1'].ksl[0] = 'on_corr_ip.1 * acb2v.r1'
line['mcb1.l1'].knl[0] = 'on_corr_ip.1 * acb1h.l1'
line['mcb2.l1'].knl[0] = 'on_corr_ip.1 * acb2h.l1'
line['mcb1.l1'].ksl[0] = 'on_corr_ip.1 * acb1v.l1'
line['mcb2.l1'].ksl[0] = 'on_corr_ip.1 * acb2v.l1'
