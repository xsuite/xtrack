...
line['on_sol_ipg'] = 0
line['on_sol_ipj'] = 0
line['on_comp_sol_left_ipa'] = 0
line['on_comp_sol_left_ipd'] = 0
line['on_comp_sol_left_ipg'] = 0
line['on_comp_sol_left_ipj'] = 0
line['on_comp_sol_right_ipa'] = 0
line['on_comp_sol_right_ipd'] = 0
line['on_comp_sol_right_ipg'] = 0
line['on_comp_sol_right_ipj'] = 0
...
for ip_name in config.keys():
    ...
    # Switch on compensation solenoids
    line['on_comp_sol_left_' + ip_name] = 1
    line['on_comp_sol_right_' + ip_name] = 1
    ...
    line[f'on_comp_sol_left_{ip_name}'] = f'on_sol_corr_{ip_name}'
    line[f'on_comp_sol_right_{ip_name}'] = f'on_sol_corr_{ip_name}'
