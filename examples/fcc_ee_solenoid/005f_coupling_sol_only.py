...
env['on_sol_ipg'] = 0
env['on_sol_ipj'] = 0
env['on_comp_sol_ipa'] = 0
env['on_comp_sol_ipd'] = 0
env['on_comp_sol_ipg'] = 0
env['on_comp_sol_ipj'] = 0
...
env['on_sol_ipg'] = 1
env['on_sol_ipj'] = 1
env['on_comp_sol_ipa'] = 1
env['on_comp_sol_ipd'] = 1
env['on_comp_sol_ipg'] = 1
env['on_comp_sol_ipj'] = 1
