...
# assert isinstance(line['mbb.10150_entry'], xt.Marker)
# assert isinstance(line['mbb.10150..entry_map'], xt.DipoleEdge)
...
# assert line['mbb.10150..entry_map'].model == 'full'
# assert line['mbb.10150..entry_map'].side == 'entry'
# assert line['mbb.10150_dex'].model == 'full'
# assert line['mbb.10150_dex'].side == 'exit'

# line.configure_bend_model(edge='linear')

# assert line['mbb.10150..entry_map'].model == 'linear'
# assert line['mbb.10150..entry_map'].side == 'entry'
