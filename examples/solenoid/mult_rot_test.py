...
for test_element, test_sol, title in zip(
    ...
    ########################################
    for i, (rot_x, rot_y) in enumerate(
        zip([0, X_ROT, 0, X_ROT],[0, 0, Y_ROT, Y_ROT])):
        # TODO: No way to compare this currently?!?
        test_sol.mult_rot_x = rot_x
        test_sol.mult_rot_y = rot_y
        ...
        axs[i].set_title(f'Rot x = {rot_x} [TBD], Rot y = {rot_y} [TBD]')
