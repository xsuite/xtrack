...
for bn in ['b1', 'b2']:
    ...
    muxip1_l = collider[f'muxip1{bn}_l']
    muyip1_l = collider[f'muyip1{bn}_l']
    muxip1_r = collider[f'muxip1{bn}_r']
    muyip1_r = collider[f'muyip1{bn}_r']

    muxip5_l = collider[f'muxip5{bn}_l']
    muyip5_l = collider[f'muyip5{bn}_l']
    muxip5_r = collider[f'muxip5{bn}_r']
    muyip5_r = collider[f'muyip5{bn}_r']

    muxip2 = collider[f'muxip2{bn}']
    muyip2 = collider[f'muyip2{bn}']
    muxip4 = collider[f'muxip4{bn}']
    muyip4 = collider[f'muyip4{bn}']
    muxip6 = collider[f'muxip6{bn}']
    muyip6 = collider[f'muyip6{bn}']
    muxip8 = collider[f'muxip8{bn}']
    muyip8 = collider[f'muyip8{bn}']

    mux12 = collider[f'mux12{bn}']
    muy12 = collider[f'muy12{bn}']
    mux45 = collider[f'mux45{bn}']
    muy45 = collider[f'muy45{bn}']
    mux56 = collider[f'mux56{bn}']
    muy56 = collider[f'muy56{bn}']
    mux81 = collider[f'mux81{bn}']
    muy81 = collider[f'muy81{bn}']

    betx_ip1_init = collider[f'betxip1{bn}']
    bety_ip1_init = collider[f'betyip1{bn}']
    betx_ip5_init = collider[f'betxip5{bn}']
    bety_ip5_init = collider[f'betyip5{bn}']

    betx_ip2 = collider[f'betxip2{bn}']
    bety_ip2 = collider[f'betyip2{bn}']

    alfx_ip3 = collider[f'alfxip3{bn}']
    alfy_ip3 = collider[f'alfyip3{bn}']
    betx_ip3 = collider[f'betxip3{bn}']
    bety_ip3 = collider[f'betyip3{bn}']
    dx_ip3 = collider[f'dxip3{bn}']
    dpx_ip3 = collider[f'dpxip3{bn}']
    mux_ir3 = collider[f'muxip3{bn}']
    muy_ir3 = collider[f'muyip3{bn}']

    alfx_ip4 = collider[f'alfxip4{bn}']
    alfy_ip4 = collider[f'alfyip4{bn}']
    betx_ip4 = collider[f'betxip4{bn}']
    bety_ip4 = collider[f'betyip4{bn}']
    dx_ip4 = collider[f'dxip4{bn}']
    dpx_ip4 = collider[f'dpxip4{bn}']

    alfx_ip6 = collider[f'alfxip6{bn}']
    alfy_ip6 = collider[f'alfyip6{bn}']
    betx_ip6 = collider[f'betxip6{bn}']
    bety_ip6 = collider[f'betyip6{bn}']
    dx_ip6 = collider[f'dxip6{bn}']
    dpx_ip6 = collider[f'dpxip6{bn}']

    alfx_ip7 = collider[f'alfxip7{bn}']
    alfy_ip7 = collider[f'alfyip7{bn}']
    betx_ip7 = collider[f'betxip7{bn}']
    bety_ip7 = collider[f'betyip7{bn}']
    dx_ip7 = collider[f'dxip7{bn}']
    dpx_ip7 = collider[f'dpxip7{bn}']
    mux_ir7 = collider[f'muxip7{bn}']
    muy_ir7 = collider[f'muyip7{bn}']

    alfx_ip8 = collider[f'alfxip8{bn}']
    alfy_ip8 = collider[f'alfyip8{bn}']
    betx_ip8 = collider[f'betxip8{bn}']
    bety_ip8 = collider[f'betyip8{bn}']
    dx_ip8 = collider[f'dxip8{bn}']
    dpx_ip8 = collider[f'dpxip8{bn}']
