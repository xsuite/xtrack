...
segm_1 = xt.LinearTransferMatrix(Q_x=0.4, Q_y=0.3, Q_s=0.0001, length=0.1,
...
segm_2 = xt.LinearTransferMatrix(Q_x=0.21, Q_y=0.32, Q_s=0.0002, length=0.2,
...
assert np.allclose(tw.dx, [10, 0, 10], atol=1e-5, rtol=0)
assert np.allclose(tw.dy, [0, 20, 0], atol=1e-5, rtol=0)
