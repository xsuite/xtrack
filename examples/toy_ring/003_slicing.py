...
# mb2.1..entry_map 6.6   False ThinSliceBendEntry
# drift_mb2.1..0   6.6    True DriftSliceBend
# mb2.1..0         7.6   False ThinSliceBend
# drift_mb2.1..1   7.6    True DriftSliceBend
# mb2.1..1         8.6   False ThinSliceBend
# drift_mb2.1..2   8.6    True DriftSliceBend
# mb2.1..exit_map  9.6   False ThinSliceBendExit
...
# Table: 9 rows, 4 cols
# name                   s isthick element_type
# mqd.2_entry         15.9   False Marker
# drift_mqd.2..0      15.9    True DriftSliceQuadrupole
# mqd.2..0         15.9375   False ThinSliceQuadrupole
# drift_mqd.2..1   15.9375    True DriftSliceQuadrupole
# mqd.2..1           16.05   False ThinSliceQuadrupole
# drift_mqd.2..2     16.05    True DriftSliceQuadrupole
# mqd.2..2         16.1625   False ThinSliceQuadrupole
# drift_mqd.2..3   16.1625    True DriftSliceQuadrupole
# mqd.2_exit          16.2   False Marker
...
# mqf.1..0            0    True ThickSliceQuadrupole
# mqf.1..1         0.15    True ThickSliceQuadrupole
