...
plt.plot(tw_no_rad.s, tw_sympl.betx*p0corr/tw_no_rad.betx - 1)
plt.plot(tw_no_rad.s, tw_scale_as_co.betx*p0corr/tw_no_rad.betx - 1)
plt.ylabel(r'$\Delta \beta_x / \beta_x$')

plt.subplot(2,1,2)
plt.plot(tw.s, tw.bety*p0corr/tw_no_rad.bety-1)
plt.plot(tw_no_rad.s, tw_sympl.bety*p0corr/tw_no_rad.bety - 1)
plt.plot(tw_no_rad.s, tw_scale_as_co.bety*p0corr/tw_no_rad.bety - 1)
...
assert np.allclose(tw.betx*p0corr, tw_no_rad.betx, rtol=0.02, atol=0)
assert np.allclose(tw_sympl.betx*p0corr, tw_no_rad.betx, rtol=0.02, atol=0)
assert np.allclose(tw_scale_as_co.betx, tw_no_rad.betx, rtol=0.02, atol=0)

assert np.allclose(tw.bety*p0corr, tw_no_rad.bety, rtol=0.02, atol=0)
assert np.allclose(tw_sympl.bety*p0corr, tw_no_rad.bety, rtol=0.02, atol=0)
assert np.allclose(tw_scale_as_co.bety, tw_no_rad.bety, rtol=0.02, atol=0)
...
eneloss_real_tracking = tw.eneloss_turn
