...
Use odd num_phi=9 so the highest even scalar-potential term is included in Ax.
The shared runner checks num_phi+2, reference integration, and RK4 refinement,
...
def make_case():
    ...
    return FieldCase('Curved solenoid', length=1., h=0.3, num_phi=9,
