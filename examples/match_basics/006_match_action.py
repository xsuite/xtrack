...
class ActionMeasAmplDet(xt.Action):
    ...
    def __init__(self, line, nemitt_x, nemitt_y, num_turns=256,
        ...
        self.Jx_0 = a0_sigmas**2 * nemitt_x / 2
        self.Jx_1 = a1_sigmas**2 * nemitt_x / 2
        self.Jx_2 = a2_sigmas**2 * nemitt_x / 2
        self.Jy_0 = a0_sigmas**2 * nemitt_y / 2
        self.Jy_1 = a1_sigmas**2 * nemitt_y / 2
        self.Jy_2 = a2_sigmas**2 * nemitt_y / 2

        self.particles0 = line.build_particles(
                            method='4d',
                            zeta=0, delta=0,
    ...
    def run(self):
        particles = self.particles0.copy()
        ...
        det_xx = (qx[1] - qx[0]) / (self.Jx_2 - self.Jx_1)
        det_yy = (qy[3] - qy[2]) / (self.Jy_2 - self.Jy_1)
        det_xy = (qx[3] - qx[2]) / (self.Jy_2 - self.Jy_1)
        det_yx = (qy[1] - qy[0]) / (self.Jx_2 - self.Jx_1)
