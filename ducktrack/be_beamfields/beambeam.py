...
class BeamBeam6D(Element):
    ...
    def from_dict(cls, dct):
        ...
        if 'slices_other_beam_Sigma_11_star' in dct.keys():
            ...
            kwargs = {
                'phi': np.angle(dct['ços_phi'] + 1j * dct['sin_phi']),
                'alpha': np.angle(dct['ços_alpha'] + 1j * dct['sin_alpha']),
                'x_bb_co': dct['other_beam_shift_x'],
                'y_bb_co': dct['other_beam_shift_y'],
                'charge_slices': dct['slices_other_beam_num_particles']*qe,
                'zeta_slices': z_slices,
                'sigma_11': dct['slices_other_beam_Sigma_11_star'],
                'sigma_12': dct['slices_other_beam_Sigma_12_star']*dct['cos_phi'],
                'sigma_13': dct['slices_other_beam_Sigma_13_star'],
                'sigma_14': dct['slices_other_beam_Sigma_14_star']*dct['cos_phi'],
                'sigma_22': dct['slices_other_beam_Sigma_22_star']*dct['cos_phi']*dct['cos_phi'],
                'sigma_23': dct['slices_other_beam_Sigma_23_star']*dct['cos_phi'],
                'sigma_24': dct['slices_other_beam_Sigma_24_star']*dct['cos_phi']*dct['cos_phi'],
                'sigma_33': dct['slices_other_beam_Sigma_33_star'],
                'sigma_34': dct['slices_other_beam_Sigma_34_star']*dct['cos_phi'],
                'sigma_44': dct['slices_other_beam_Sigma_44_star']*dct['cos_phi']*dct['cos_phi'],
                'x_co': dct['other_beam_shift_x'],
                'px_co': dct['other_beam_shift_px'],
                'y_co': dct['other_beam_shift_y'],
                'py_co': dct['other_beam_shift_py'],
                'zeta_co': dct['other_beam_shift_zeta'],
                'delta_co': dct['other_beam_shift_pzeta'],
