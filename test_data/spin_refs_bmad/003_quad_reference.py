...
file_name = 'quadrupole_bmad.json'

env = xt.Environment()
line = env.new_line(components=[
    env.new('myquadrupole', xt.Quadrupole, k1=0.01, length=0.02),
    env.new('mymarker', xt.Marker),
])

test_cases = [
    {'x': 1e-3, 'px': 1e-5, 'y': 2e-3, 'py': 2e-5, 'delta': 1e-3, 'spin_x': 0.1, 'spin_z': 0.2, 'atol': 6e-8},
    # Vary delta in np.linspace(-0.01, 0.01, 5)
    {'x': 1e-3, 'px': 1e-5, 'y': 2e-3, 'py': 2e-5, 'delta': -0.01, 'spin_x': 0.1, 'spin_z': 0.2, 'atol': 6e-8},
    {'x': 1e-3, 'px': 1e-5, 'y': 2e-3, 'py': 2e-5, 'delta': -0.005, 'spin_x': 0.1, 'spin_z': 0.2, 'atol': 6e-8},
    {'x': 1e-3, 'px': 1e-5, 'y': 2e-3, 'py': 2e-5, 'delta': 0, 'spin_x': 0.1, 'spin_z': 0.2, 'atol': 6e-8},
    {'x': 1e-3, 'px': 1e-5, 'y': 2e-3, 'py': 2e-5, 'delta': 0.005, 'spin_x': 0.1, 'spin_z': 0.2, 'atol': 6e-8},
    {'x': 1e-3, 'px': 1e-5, 'y': 2e-3, 'py': 2e-5, 'delta': 0.01, 'spin_x': 0.1, 'spin_z': 0.2, 'atol': 6e-8},
    # Vary px, py in np.linspace(-0.03, 0.03, 5), np.linspace(-0.02, 0.02, 5)
    {'x': 1e-3, 'px': -0.03, 'y': 2e-3, 'py': -0.02, 'delta': 1e-3, 'spin_x': 0.1, 'spin_z': 0.2, 'atol': 6e-5},
    {'x': 1e-3, 'px': -0.015, 'y': 2e-3, 'py': -0.01, 'delta': 1e-3, 'spin_x': 0.1, 'spin_z': 0.2, 'atol': 3e-5},
    {'x': 1e-3, 'px': 0, 'y': 2e-3, 'py': 0, 'delta': 1e-3, 'spin_x': 0.1, 'spin_z': 0.2, 'atol': 2e-7},
    {'x': 1e-3, 'px': 0.015, 'y': 2e-3, 'py': 0.01, 'delta': 1e-3, 'spin_x': 0.1, 'spin_z': 0.2, 'atol': 3e-5},
    {'x': 1e-3, 'px': 0.03, 'y': 2e-3, 'py': 0.02, 'delta': 1e-3, 'spin_x': 0.1, 'spin_z': 0.2, 'atol': 6e-5},
]
